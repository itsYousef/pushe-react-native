...
public class RNPusheWritable {
    ...
    public WritableMap notificationButtonDataToWritableMap(NotificationButtonData notificationButtonData) {
        WritableMap writableMap = new WritableNativeMap();
        
        writableMap.putString("id", notificationButtonData.getId());
        writableMap.putString("title", notificationButtonData.getText());
